...
const Dashboard = () => {
    ...
    return (
        <div className="p-4">
            ...
            {/* Filters */}
            <div className="d-flex align-items-center gap-2 mb-4 filters-row" style={{ overflowX: 'auto', whiteSpace: 'nowrap', scrollbarWidth: 'none' }}>
                {[
                    { name: 'dateRange', label: 'Date Range', options: ['Today', 'This Week', 'This Month', 'Custom'] },
                    {
                        name: 'country', label: 'Country', options: [
                            'Hungary', 'UK', 'Cyprus', 'Canada', 'Malaysia',
                            'Lithuania', 'Latvia', 'Germany', 'New Zealand', 'usa', 'Others'
                        ]
                    },
                    {
                        name: 'counselor',
                    ...
                    {
                        name: 'leadSource', label: 'Lead Source', options: [
                            'Whatsapp', 'Facebook', 'YouTube', 'Website', 'Referral',
                            'Event', 'Agent', 'Office Visit', 'Hotline', 'Seminar', 'Expo', 'Other'
                        ]
                    }
                ].map(filter => (
                    <Form.Select
